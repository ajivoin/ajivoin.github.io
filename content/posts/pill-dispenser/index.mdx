...
description: "A Hack OHI/O 2019 project (3rd place overall): a connected pill dispenser and web app built with Ruby on Rails and Arduino to help patients stay on top of their medication schedule."
publishDate: "03 Nov 2019"
tags: ["hackathon", "arduino", "rails"]
---
...
**[Andrew Jivoin](https://jivoin.com/)** — Andrew is studying Computer Science and Theoretical Math at Ohio State. He wrote some Ruby code and took some pictures and videos of the project.
...
**[Andrew Lubinger](http://web.cse.ohio-state.edu/~lubinger.1/)** — Andrew is studying Computer Science and Engineering at The Ohio State University.
...
<div class="aspect-video">
	<iframe
		class="h-full w-full"
		src="https://www.youtube-nocookie.com/embed/Dytg9O8Kf9Y"
		title="Smart Pill Dispenser demo video"
		frameborder="0"
